...
const prices = [
  20, 22, 24, 26, 28, 30, 32, 34, 36, 38, 40, 40, 43, 43, 45, 46, 58, 61, 64,
        ...
        <div className="p-4">
          <div className="flex gap-2">
            <div className="text-xs leading-6 text-gray-500">
              Technology and Caregiving at your fingertips
            </div>
          ...
          <div className="mt-3 border-t border-gray-200 pt-5">
            <div className="flex items-baseline gap-2">
              <div className="text-xs tabular-nums tracking-tight text-gray-900">
                Right now, there are more than 56 million seniors (aged 65+)
                living in the U.S
              </div>
            </div>
            <div className="mt-6 flex gap-4 text-xs text-gray-500">
              ...
              <div className="font-semibold text-cyan-600">2023</div>
            ...
            <div className="mt-3 divide-y divide-gray-100 text-sm">
              <div className="flex justify-between py-1">
                <div className="text-gray-500">Seniors</div>
              ...
              <div className="flex justify-between py-1">
                <div className="text-gray-500">Temporary Care</div>
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            <h1 className="text-4xl font-medium tracking-tight text-gray-900">
              Compassionate Care Starts Here - Transforming Visions into
              Reality.
            </h1>
            <p className="mt-6 text-lg text-gray-600">
              Welcome to Caregiver Compass where we blend technology and human
              compassion to create a personalized care experience. We value the
              extraordinary efforts of caregivers and aim to provide them with a
              streamlined, efficient platform that meets their needs.
            </p>
            <div className="mt-8 flex flex-wrap gap-x-6 gap-y-4">
              <AppStoreLink />
              <Button
                href="https://www.youtube.com/watch?v=sl3Dc1kERto"
                variant="outline"
              >
            ...
            >
              {[
                ...
                <li key={name} className={clsx("flex", className)}>
                  <img src={logo} alt={name} className="h-8" loading="lazy" />
                </li>
              ))}
            </ul>
          </div>

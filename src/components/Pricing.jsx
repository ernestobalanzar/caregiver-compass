...
const plans = [
  ...
  },
  {
    ...
    description:
      "You’ve been in this space for a while. Explore your full potential.",
    button: {
      label: "Subscribe",
      href: "/register",
    },
      ...
      <Container>
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-2 text-lg text-gray-600">
            Our Caregiver Plans are designed with the individual caregiver in
            mind, and it enhances your ability to provide comprehensive care to
            your loved ones. The financial stress related to care can be
            overwhelming, which is why we've included an advanced Financial &
            Legal feature, allowing you to navigate financial obligations and
            legal matters with greater ease.
          </p>
        </div>
